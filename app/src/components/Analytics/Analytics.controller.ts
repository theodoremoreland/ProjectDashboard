...
export const getTopTechnologies = (projects: TaggedRepoData[], limit: number = 10): {
  technology: string;
  count: number;
}[] => {
...
export const getCourseCounts = (projects: TaggedRepoData[]): { id: number, value: number, label: string }[] => {
...
export const getContextCounts = (projects: TaggedRepoData[]): { id: number, value: number, label: string }[] => {
